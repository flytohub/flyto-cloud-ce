...
- [Open-core model](open-core.md): product architecture and commercial
  boundary; this does not classify PolyForm code as OSI open source.

Repository operations are documented in [Project](../PROJECT.md),
[Architecture](../ARCHITECTURE.md), [State](../STATE.md),
